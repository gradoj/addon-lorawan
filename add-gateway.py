...
# Get server from environment variable or use default
server = os.getenv("CHIRPSTACK_SERVER", "localhost:8080")
print(f"Using ChirpStack server: {server}")
...
if __name__ == "__main__":
    ...
    try:
        ...
        if e.code() == grpc.StatusCode.ALREADY_EXISTS:
            print("Gateway already exists (this is okay)")
        else:
